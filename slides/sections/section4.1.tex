...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=10.5cm]{acgt_02.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=8cm]{sequence_analysis.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=8cm]{dna_packing.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=9cm]{gc_sw.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=9cm]{codon_04.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=4cm]{cai_01.png}
    \\
    \includegraphics[width=7cm]{cai_02.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{检索}
    \begin{itemize}
      ...
      \item 翻墙方法：自由门，Lantern（蓝灯），shadowsocks，VPN，……
    \end{itemize}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=8cm]{site_matrix.png}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{motif_pwm_01.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=9cm]{sliding_window_seq.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=11cm]{cpg_hmm.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=7cm]{sw_01.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=11cm]{sw_window_size.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{dp_01.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=6.8cm]{cluster_01.jpg}
    \includegraphics[width=5cm]{cluster_02.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=5cm]{da_01.jpg}
    \includegraphics[width=5.5cm]{da_03.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=7.5cm]{ann_01.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth]{dl_01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=5.5cm]{markov_chain.png}
    \quad
    \includegraphics[width=6cm]{hmm_model.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=10cm]{hmm_01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=6.4cm]{hmm_03.png}
    \includegraphics[width=5.4cm]{hmm_04.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=10.5cm]{hmm_04.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{bayes_01.png}
    \includegraphics[width=0.6\textwidth]{bayes_02.png}
  \end{figure}
\end{frame}

\begin{frame}
  \frametitle{序列分析中的算法 | 贝叶斯定理 | 应用}
  \begin{figure}
    \centering
    \visible<1->{\includegraphics[width=0.9\textwidth]{bayes_gun_01.png}}
    \visible<2->{\includegraphics[width=0.6\textwidth]{bayes_gun_02.png}}
    \visible<3->{\includegraphics[width=0.7\textwidth]{bayes_gun_03.png}}
  \end{figure}
\end{frame}
...
从检测结果的概率来看，检测结果是比较准确的（99\%），但是贝叶斯定理却可以揭示一个潜在的问题。如果某人检测呈阳性，其吸毒的概率只有大约33\%，不吸毒的可能性比较大。假阳性高，则检测的结果不可靠。
  ...
  \begin{figure}
    \centering
    \visible<3->{\includegraphics[width=0.4\textwidth]{bayes_drug.png}}
  \end{figure}
\end{frame}
...
\begin{frame}
  \frametitle{序列分析中的算法 | 贝叶斯定理 | 应用}
  \begin{block}{胰腺癌检测}
即使100\%的胰腺癌症患者都有某症状，而某人有同样的症状，绝对不代表该人有100\%的概率得胰腺癌，还需要考虑先验概率，假设胰腺癌的发病率是十万分之一，而全球有同样症状的人有万分之一，则此人得胰腺癌的概率只有十分之一，90\%的可能是是假阳性。
  \end{block}
  \pause
  \begin{block}{不良种子检测}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \visible<2->{\includegraphics[width=0.9\textwidth]{bayes_love_01.jpg}}
    \visible<3->{\includegraphics[width=0.8\textwidth]{bayes_love_02.jpg}}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{bayes_love_03.jpg}
    \includegraphics[width=0.88\textwidth]{bayes_love_04.jpg}
  \end{figure}
  \pause
  \vspace{-2em}
  \begin{block}{结论}
