...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth]{hmm_gene_p.png}
  \end{figure}
\end{frame}
...
P(患病)即是发病率0.001，那P(无患病)就是0.999；P(阳性|患病)是钼靶X光成像检测的真阳性率0.90，而P(阳性|无患病)是该检测的假阳性率0.09。
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{bayes_breast_01.png}\\
    \vspace{1em}
    \includegraphics[width=0.6\textwidth]{bayes_breast_02.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{bayes_breast_03.png}
  \end{figure}
\end{frame}
