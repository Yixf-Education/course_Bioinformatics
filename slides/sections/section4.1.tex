...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{dp.01.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=6.8cm]{cluster.01.jpg}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=6.4cm]{hmm.03.png}
    \includegraphics[width=5.4cm]{hmm.04.png}
  \end{figure}
\end{frame}
