...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=7cm]{motif_pwm.png}\\
    \vspace{0.5em}
    \includegraphics[width=7cm]{motif_icm.png}\\
    \vspace{0.5em}
    \includegraphics[width=3cm]{motif_ic_total.png}
    \hspace{1em}
    \includegraphics[width=4.5cm]{motif_uncertainty.png}\\
    \vspace{0.5em}
    \includegraphics[width=4cm]{motif_ic_final.png}
    \hspace{1em}
...
\begin{frame}
  ...
  \begin{center}
    ...
    \includegraphics[width=11cm]{gapminder_2015.png}
  \end{center}
\end{frame}
