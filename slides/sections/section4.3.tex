...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{rna.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.85\textwidth]{ncRNA_class.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.85\textwidth]{RNA_class_02.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=12cm]{splicing_mechanism_10.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=11cm]{splicing_mechanism_11.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=7.5cm]{as_model_02.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=9cm]{as_examples_11.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=8cm]{splicing_mechanism_20.jpg}
  \end{figure}
\end{frame}
\note{
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=10cm]{splicing_activation.jpg}\\
    \vspace{1em}
    \includegraphics[width=10cm]{splicing_repression.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=8cm]{as_random_forest.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  \frametitle{miRNA | 透过表象看本质 | MiRscan}
  \begin{figure}
    \centering
    \includegraphics[width=11cm]{mirscan_01.jpg}
  \end{figure}
\end{frame}

\begin{frame}
  \frametitle{miRNA | 透过表象看本质 | miRFinder}
  \begin{figure}
    \centering
...
\begin{frame}
  \frametitle{miRNA | 透过表象看本质 | HMM}
  \begin{figure}
    \centering
    \includegraphics[width=11cm]{mirna_hmm_1.jpg}
  \end{figure}
\end{frame}

\begin{frame}
  \frametitle{miRNA | 透过表象看本质 | miRanda}
  \begin{figure}
    \centering
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.86\textwidth]{mRNA_vs_lncRNA.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.65\textwidth]{lncRNA_class.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=4.8cm]{ceRNA_1_01.jpg}\qquad
    \includegraphics[width=4.3cm]{ceRNA_2_01.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=5cm]{ceRNA_3_01.jpg}\qquad
    \includegraphics[width=4.5cm]{ceRNA_3_02.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  \frametitle{lncRNA | lncRNA与肿瘤}
  \begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{lncRNA_cancer.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  \frametitle{RNA修饰 | 简介}
  \begin{block}{RNA modification}
    RNA modifications are changes to the chemical composition of RNA molecules post-synthesis that have the potential to alter function or stability.
  \end{block}
  \begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{RNAm_intro_01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.85\textwidth]{RNAm_role_01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.85\textwidth]{RNAm_disease_01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=3.5cm]{poem.jpg}
  \end{figure}
\end{frame}
