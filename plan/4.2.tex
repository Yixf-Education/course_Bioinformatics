...
\begin{itemize}
  ...
  \item （30'）重复序列分析：讲解重复序列的概念、分类及特点，介绍常用数据库与分析工具。
  \item （50'）基因识别：介绍基因和基因识别的基本概念，回顾原核基因和真核基因的结构特点并进行比较，讲解基因识别的主要方法与策略，介绍基因识别的常用工具。
...
\zhongdian{
\begin{itemize}
  \item 重点：重复序列的分类，原核基因和真核基因的结构特点。
