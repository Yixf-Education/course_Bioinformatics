...
\kecheng{生物信息学}
%实验名称
\shiyan{实验六\ DNA序列的基本信息及特征分析}
%教师姓名
\jiaoshi{伊现富}
%职称
\zhicheng{讲师}
%教学日期（格式：XXXX年XX月XX日XX时-XX时）
\riqi{2018年11月30日8:00-10:45}
...
\fenpei{
\begin{itemize}
  \item （10'）查询核酸序列：简单介绍NCBI数据库，讲解并演示Nucleotide数据库的使用。
  \item （10'）EMBOSS简介：介绍EMBOSS软件软件包，讲解并演示compseq等工具的使用方法。
  \item （10'）序列组份分析：回顾序列组份分析的主要内容。
  \item （10'）开放阅读框分析：回顾ORF的定义、相位的概念和最长ORF法。
  \item （95'）实验操作：对人类CD9基因序列进行组分分析，对大肠杆菌基因组序列进行ORF分析。
\end{itemize}
}
