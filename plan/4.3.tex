...
\begin{itemize}
  ...
  \item （35'）mRNA选择性剪接：介绍剪接和选择性剪接的基本概念，讲解mRNA选择性剪接的主要机制，介绍相关的数据库和分析工具。
  \item （35'）miRNA及其靶基因预测：回顾miRNA的特点、生成过程、作用方式和生物学功能，讲解miRNA预测和miRNA靶基因预测的主要方法，介绍常用的数据库和分析工具。
...
\begin{enumerate}
  \item 基本概念
    ...
    \end{itemize}
  \item 主要机制\textcolor{red}{（通过示意图和实例详解每种机制）}
    \begin{itemize}
